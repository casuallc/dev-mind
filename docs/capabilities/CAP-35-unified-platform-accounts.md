...
> 能力 ID：CAP-35 ｜ 分类：底座 ｜ 状态：已落地（2026-09-09：账号模型 + /api/me/platform-accounts +
> 统一身份链切入 push/MR/Jira transition/worklog + 机器人凭证可选 + 启动迁移器 + 前端「第三方账号」页；
> 单测 8 项通过，端到端冒烟通过）｜ 日期：2026-09-09
>
