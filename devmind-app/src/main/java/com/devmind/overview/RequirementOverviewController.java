...
/**
 * 需求主线聚合 API（P0-6 步骤 4）。
 */
@RestController
@RequestMapping("/api/projects/{projectId}/requirements/{reqId}/overview")
public class RequirementOverviewController {
    ...
    @GetMapping
    public RequirementOverviewView overview(@PathVariable String projectId, @PathVariable String reqId) {
        return service.overview(projectId, reqId);
    }
}
